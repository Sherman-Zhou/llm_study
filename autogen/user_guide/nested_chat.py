...
#1. Lead_Teacher_Agent (to human_agent):
#2 human_agent (to Lead_Teacher_Agent):

# Starting a new chat
#2.1 Lead_Teacher_Agent (to Curriculum_Agent):
#2.2 Curriculum_Agent (to Lead_Teacher_Agent):
#2.3 Lead_Teacher_Agent (to Curriculum_Agent):
#2.4 Curriculum_Agent (to Lead_Teacher_Agent):

# Starting a new chat....
#3. Lead_Teacher_Agent (to chat_manager):
#3.1 Nested Chat:
# 3.1.1 Next speaker: Lesson_Reviewer_Agent
# Lesson_Reviewer_Agent (to chat_manager):

# Next speaker: Lesson_Reviewer_Agent
# Lesson_Reviewer_Agent (to chat_manager):
# Next speaker: Lesson_Reviewer_Agent
#  Lesson_Reviewer_Agent (to chat_manager):

#Starting a new chat....
# Lead_Teacher_Agent (to formatter_agent):
# formatter_agent (to Lead_Teacher_Agent):
# Lead_Teacher_Agent (to human_agent):

#                                          | curriculum_agent                        curriculum_agent
# human_agent <==>  Lead_Teacher_Agent <==>| planning_manager(human_agent)  <==>     lesson_formatter
#                                          | lesson_formatter                        lesson_planner_agent